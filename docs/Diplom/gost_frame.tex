...
\newcommand{\GostDocName}{Разработка интерактивной обучающей веб-платформы по~основам сопротивления материалов с~визуализацией НДС}  % (1) Наименование
\newcommand{\GostOrganization}{Московский политех, гр.~221-171} % (9) Организация
\newcommand{\GostDeveloper}{Водопьянова Е.~В.}                      % Разраб. — фамилия
\newcommand{\GostChecker}{Лукьянов М.~Н.}                           % Пров.
...
% ============================================================
% Стили страниц
% Номер страницы — вверху по центру (ГОСТ 7.32-2017, п. 6.3.1).
% Рамка и штамп рисуются поверх через overlay, не мешая тексту.
% ============================================================
\fancypagestyle{gostfirst}{%
  \fancyhf{}%
  \renewcommand{\headrulewidth}{0pt}%
  \renewcommand{\footrulewidth}{0pt}%
  \fancyhead[C]{\thepage\DrawGostFrame}%
