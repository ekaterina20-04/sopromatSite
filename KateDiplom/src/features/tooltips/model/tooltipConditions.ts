...
export const TOOLTIP_CONDITIONS: TooltipCondition[] = [
  ...
  },
  {
    ...
    description:
      'При нескольких нагрузках эпюры складываются. Результирующая Q(x) = сумма вкладов всех нагрузок. Это справедливо для линейной расчётной модели.',
  ...
  },
  {
    ...
    description:
      'Максимальный прогиб превышает L/250 — конструкция работает за пределами допустимых деформаций. Уменьшите нагрузку или измените расчётную схему.',
    check: (config, result) => {
